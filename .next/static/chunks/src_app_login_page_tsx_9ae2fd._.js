...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/data/users.ts [app-client] (ecmascript)"); // Assuming this path is correct
...
const validationSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.object({
    ...
    password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.string().min(6, "Minimum 6 characters").required("Password is required")
});
function Login() {
    _s();
    ...
    const handleSubmit = async (values)=>{
        let user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findUserByEmail"])(values.email);
...
_s(Login, "d+qZy1tupCTi08/cU0q1/PZp3mI=", false, function() {
    return [
